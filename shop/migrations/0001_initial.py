# Generated by Django 5.0.6 on 2024-08-22 09:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mail', models.EmailField(max_length=254, unique=True, verbose_name='Електронна пошта')),
                ('phone_number', models.TextField(blank=True, max_length=9, null=True, verbose_name='Номер телефону')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Адресат')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade', models.CharField(blank=True, choices=[('5', 'Відмінно'), ('4', 'Добре'), ('3', 'Нормально'), ('2', 'Не добре'), ('1', 'Жахливо')], max_length=20, null=True, verbose_name='Оцінка')),
